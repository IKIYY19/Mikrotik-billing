...
const billingMigrations = [
  ...
  `CREATE TABLE IF NOT EXISTS promo_campaigns (
    ...
    min_invoice_amount DECIMAL(10,2),
  ...
  `CREATE INDEX IF NOT EXISTS idx_promo_campaigns_code ON promo_campaigns(code)`,
  `CREATE INDEX IF NOT EXISTS idx_promo_campaigns_status ON promo_campaigns(status)`,

  // Promo redemptions (tracks each use of a promo code)
  ...
  `CREATE TABLE IF NOT EXISTS referral_programs (
    ...
    name VARCHAR(200) NOT NULL,
    description TEXT,
    referrer_reward_type VARCHAR(20) NOT NULL DEFAULT 'wallet_credit',
    referrer_reward_value DECIMAL(10,2) NOT NULL DEFAULT 0,
    referee_reward_type VARCHAR(20) NOT NULL DEFAULT 'wallet_credit',
    referee_reward_value DECIMAL(10,2) NOT NULL DEFAULT 0,
    referee_qualification VARCHAR(30) DEFAULT 'first_payment',
    qualification_amount DECIMAL(10,2),
  ...
  // Referral codes (one per customer per program)
  ...
  // Referral records (tracks each referral relationship)
  `CREATE TABLE IF NOT EXISTS referrals (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    UNIQUE(referee_customer_id, program_id)
  )`,
