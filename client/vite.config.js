...
export default defineConfig({
  ...
  server: {
    port: 5173,
    proxy: {
      "/api": { target: `http://localhost:${process.env.PORT || 5000}`, changeOrigin: true },
      "/mikrotik": { target: `http://localhost:${process.env.PORT || 5000}`, changeOrigin: true },
      "/logos": { target: `http://localhost:${process.env.PORT || 5000}`, changeOrigin: true },
    },
  },
});
