...
const mainNavItems = [
  ...
  { to: "/router-link", icon: Link, label: "Router Link", feature: "settings" },
...
const navGroups = [
  {
    ...
    items: [
      ...
      { to: "/promos", icon: Tag, label: "Promo Campaigns", feature: "promos" },
      { to: "/referrals", icon: Gift, label: "Referral Engine", feature: "referrals" },
