...
const PromoCampaigns = lazy(() => import("./pages/billing/PromoCampaigns").then(m => ({ default: m.PromoCampaigns })));
const ReferralEngine = lazy(() => import("./pages/billing/ReferralEngine").then(m => ({ default: m.ReferralEngine })));
                  ...
                  <main className="flex-1 overflow-auto">
                    ...
                    <Suspense fallback={<PageLoader />}>
                      <Routes>
                        ...
                        <Route path="/promos" element={<PromoCampaigns />} />
                        <Route path="/referrals" element={<ReferralEngine />} />
